...
<body>
	<div class="welcome">
		...
		<h3>A couple of tools that you will find very useful as a developer are: <h3>
			...
			<h3>A lot of web applictations require user interaction. Instead of coming up with a list of users, you can use this application to randomly create them.</h3>
